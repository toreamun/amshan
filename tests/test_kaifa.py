...
NOTIFICATION_BODY_NO_LIST_1 = "0201" + "06000016dc"
...
no_list_1 = bytes.fromhex(
    (
        (
            ...
            "090c07e3020401173416ff800000"  # APDU: DateTime
        )
...
no_list_2 = bytes.fromhex(
    (
        (
            ...
            "0f"  # APDU: tag
            "40000000"  # APDU: LongInvokeIdAndPriority
            "090c 07e40119060d091eff800000"  # APDU: DateTime
        )
        + NOTIFICATION_BODY_NO_LIST_2
    ).replace(" ", "")
)
...
no_list_3 = bytes.fromhex(
    (
        (
            ...
            "0f"  # APDU: tag
            "40000000"  # APDU: LongInvokeIdAndPriority
            "090c 07e40119060e000aff800000"  # APDU: DateTime
        )
        + NOTIFICATION_BODY_NO_LIST_3
    ).replace(" ", "")
)
...
class TestParseKaifa:
    ...
    def test_parse_se_list(self, llc_pdu, notification_body):
        ...
        if llc_pdu is not None:
            parsed = kaifa.LlcPdu.parse(llc_pdu)
            print(parsed)
        ...
        if notification_body is not None:
            parsed = kaifa.NotificationBody.parse(notification_body)
            print(parsed)
            parsed_notification_body = parsed

        assert parsed_notification_body.type == kaifa.KaifaBodyType.OBIS_ELEMENTS

        assert parsed_notification_body.length == 18
        assert_obis_element(
        ...
        date_time = parsed_notification_body.list_items[13]
    ...
    def test_parse_no_list_2(self, llc_pdu, notification_body):
        ...
        assert parsed_notification_body.length == 13
        assert parsed_notification_body.list_items[0].index == 0
        assert parsed_notification_body.list_items[0].value == "KFM_001"
        assert parsed_notification_body.list_items[1].index == 1
        assert parsed_notification_body.list_items[1].value == "6970631402614476"
        assert parsed_notification_body.list_items[2].index == 2
        assert parsed_notification_body.list_items[2].value == "MA304H3E"
        assert parsed_notification_body.list_items[3].index == 3
        assert parsed_notification_body.list_items[3].value == 9745
        assert parsed_notification_body.list_items[4].index == 4
        assert parsed_notification_body.list_items[4].value == 0
        assert parsed_notification_body.list_items[5].index == 5
        assert parsed_notification_body.list_items[5].value == 0
        assert parsed_notification_body.list_items[6].index == 6
        assert parsed_notification_body.list_items[6].value == 435
        assert parsed_notification_body.list_items[7].index == 7
        assert parsed_notification_body.list_items[7].value == 33813
        assert parsed_notification_body.list_items[8].index == 8
        assert parsed_notification_body.list_items[8].value == 28103
        assert parsed_notification_body.list_items[9].index == 9
        assert parsed_notification_body.list_items[9].value == 18178
        assert parsed_notification_body.list_items[10].index == 10
        assert parsed_notification_body.list_items[10].value == 2168
        assert parsed_notification_body.list_items[11].index == 11
        assert parsed_notification_body.list_items[11].value == 0
        assert parsed_notification_body.list_items[12].index == 12
        assert parsed_notification_body.list_items[12].value == 2188
    ...
    def test_parse_no_list_3(self, llc_pdu, notification_body):
        ...
        assert parsed_notification_body.type == kaifa.KaifaBodyType.VALUE_ELEMENTS
        assert parsed_notification_body.length == 18
        assert parsed_notification_body.list_items[0].index == 0
        assert parsed_notification_body.list_items[0].value == "KFM_001"
        assert parsed_notification_body.list_items[1].index == 1
        ...
        assert parsed_notification_body.list_items[2].value == "MA304H3E"
        assert parsed_notification_body.list_items[3].index == 3
        assert parsed_notification_body.list_items[3].value == 4904
        assert parsed_notification_body.list_items[4].index == 4
        assert parsed_notification_body.list_items[4].value == 0
        assert parsed_notification_body.list_items[5].index == 5
        assert parsed_notification_body.list_items[5].value == 0
        assert parsed_notification_body.list_items[6].index == 6
        assert parsed_notification_body.list_items[6].value == 377
        assert parsed_notification_body.list_items[7].index == 7
        assert parsed_notification_body.list_items[7].value == 14571
        assert parsed_notification_body.list_items[8].index == 8
        assert parsed_notification_body.list_items[8].value == 15643
        assert parsed_notification_body.list_items[9].index == 9
        assert parsed_notification_body.list_items[9].value == 9525
        assert parsed_notification_body.list_items[10].index == 10
        assert parsed_notification_body.list_items[10].value == 2193
        assert parsed_notification_body.list_items[11].index == 11
        assert parsed_notification_body.list_items[11].value == 0
        assert parsed_notification_body.list_items[12].index == 12
        assert parsed_notification_body.list_items[12].value == 2205
        assert parsed_notification_body.list_items[13].index == 13
        assert parsed_notification_body.list_items[13].value.datetime == datetime(
            2020, 1, 25, 14, 0, 10
        )
        assert parsed_notification_body.list_items[14].index == 14
        assert parsed_notification_body.list_items[14].value == 79591144
        assert parsed_notification_body.list_items[15].index == 15
        assert parsed_notification_body.list_items[15].value == 0
        assert parsed_notification_body.list_items[16].index == 16
        assert parsed_notification_body.list_items[16].value == 889389
        assert parsed_notification_body.list_items[17].index == 17
        assert parsed_notification_body.list_items[17].value == 3210932
...
class TestDecodeKaifa:
    ...
    def test_decode_frame_se_list(self, llc_pdu, notification_body):
        """Decode SE list."""
        if llc_pdu is not None:
            decoded = kaifa.decode_frame_content(llc_pdu)

        if notification_body is not None:
            decoded = kaifa.decode_notification_body(notification_body)
